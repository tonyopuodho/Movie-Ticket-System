...
function Trailersection() {
  ...
  return (
    <div className='px-6 md:px-16 lg:px-24 xl:px-44 py-20 overflow-hidden'>
        <p className='text-gray-300 max-w-[960px] font-medium mx-auto'>Trailer</p>
        ...
        <div className='group grid grid-cols-4 md:gap-8 mt-8 max-w-3xl mx-auto'>
            {
                dummyTrailers.map((trailer) => (
                    ...
                    ' onClick={() => {setCurrentTrailer(trailer)}}>
                        ...
                        <PlayCircleIcon strokeWidth={1.6} className='absolute top-1/2 left-1/2 md:w-8 h-5 md:h-12 transform -translate-x-1/2 -translate-y-1/2'/>
                    </div>
                ))
            }
        </div>
