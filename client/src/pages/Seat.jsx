...
import { isoTimeFormat } from '../lib/isoTime.js'
...
function Seat() {
  ...
  const groupRow = [["A","B"],["C","D"],["E","F"],["I","J"],["K","L"]]
  const getShow = async () => {
      ...
      <div className='flex flex-wrap items-center justify-center gap-2'>
        {
          Array.from({length:count},(_,i) => {
            ...
            return (
              <button key={seatId} onClick={() => handleSitClick(seatId)}
  ...
  return show ? (
    <div className='flex flex-col md:flex-row px-6 md:px-16 lg:px-40 py-30 md:pt-50'>
      {/* available timings */}
      <div className='w-60 bg-primary/10 border border-primary/20 py-10 h-max md:sticky md:top-30'>
      ...
      <div className='relative flex-1 flex flex-col items-center max-md:mt-16'>
        ...
        <button onClick={() => navigate('/my-bookings')} className='flex items-center gap-1 mt-20 bg-primary text-white px-10 py-3 rounded-full cursor-pointer'>Proceed to checkout
