  ...
  return show ? (
    <div className='px-6 md:px-16 lg:px-40 pt-30 md:pt-50'>
      <div className='flex flex-col md:flex-row gap-8 max-w-6xl mx-auto'>
        ...
        <div className='relative flex flex-col gap-3'>
          ...
          <div className='flex flex-wrap items-center gap-4 mt-4'>
            ...
            <a href='#dateSelect' className='flex items-center gap-2 px-7 py-3 text-sm bg-primary hover:bg-primary-dull transition rounded-md
            font-medium cursor-pointer active:scale-95'>              
              Buy Ticket
      ...
      <p className='text-lg font-medium mt-20'>Your favorite Cast</p>
          <div className='overflow-x-auto scrollbar-none mt-8 pb-4'>
